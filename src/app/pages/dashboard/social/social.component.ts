...
export class SocialComponent {
  ...
  constructor(private _lightbox: Lightbox, private crud: CrudService) {}

  ngOnInit(): void {
    const test: any = this.crud.fetchData(
      'https://appnodetestmkdev.azurewebsites.net/get-produits'
    );
    ...
    for (let i = 1; i <= this.storiesData.length; i++) {
      const src =
        'https://cdn.dribbble.com/userupload/3012253/file/original-dd6cf163ea8f5617304d9d41f6ff38e7.png?resize=448/506';
      const thumb =
        'https://cdn.dribbble.com/userupload/3012253/file/original-dd6cf163ea8f5617304d9d41f6ff38e7.png?resize=448/506';
      const album = {
        src: src,
